...
public:
	...
	Ray(double ox, double oy, double dx, double dy, int currentBounce = 0, double power = 1.0, int maxBounce = 50, double currentMedium=1.0) : Origin(ox, oy), Direction(dx, dy)
	{
